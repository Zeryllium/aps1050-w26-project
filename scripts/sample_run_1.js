...
async function main() {
    console.log("WARNING: This file assumes that you have run sample_run_0.js successfully")
    console.log("Executing example process.");
    console.log("========================================================");
    console.log("This file will first ask the Oracle to update sports matches 1, 2, and 3 in the blockchain.");
    ...
    console.log("Execute sample_run_2.js after observing the new state");
    console.log("\n");
